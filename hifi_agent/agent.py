...
root_agent = Agent(
    ...
    - After authentication is done, first call all fi_mcp_agent tools and get the financial data of the user and then you can start the conversation with the user.
